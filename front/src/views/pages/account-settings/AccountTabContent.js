      ...
      <Card>
        ...
        <CardBody className='py-2 my-25'>
          <div className='d-flex'>
            <div className='me-25'>
              <img className='rounded me-50' src={userData.profilePicture} alt='Generic placeholder image' height='100' width='100' />
            </div>
            ...
            <Row>
              <Col sm='6' className='mb-1'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input id='firstName'  placeholder='John' invalid={errors.firstName && true} value={(userData && userData.firstName) || 'John Doe'} />
                  )}
                />
              ...
              <Col sm='6' className='mb-1'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input id='lastName' placeholder='Doe' invalid={errors.lastName && true} value={(userData && userData.lastName)} />
                  )}
                />
              ...
              <Col sm='6' className='mb-1'>
                ...
                <Input id='emailInput' type='email' name='email' placeholder='Email' value={(userData && userData.email) || 'Exampel@Exampel.com'} />
              </Col>
              <Col sm='6' className='mb-1'>
              ...
              <Col sm='6' className='mb-1'>
                ...
                <Cleave
                  ...
                  placeholder={(userData && userData.phoneNumber) || '1234567890'}
